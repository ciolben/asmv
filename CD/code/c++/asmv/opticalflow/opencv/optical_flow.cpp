...
int start(char* argv1, char* argv2)
{
//    if (argc < 3)
//    {
...
//    }
    ...
    Mat frame0 = imread(argv1, IMREAD_GRAYSCALE);
    Mat frame1 = imread(argv2, IMREAD_GRAYSCALE);

    if (frame0.empty())
    {
        cerr << "Can't open image ["  << argv1 << "]" << endl;
        return -1;
    }
    if (frame1.empty())
    {
        cerr << "Can't open image ["  << argv2 << "]" << endl;
        return -1;
    }
