...
public:
    ...
    void setupUi(QDialog *MotionUi)
    {
        ...
        txtOut->setGeometry(QRect(10, 220, 351, 171));
        txtOut->setReadOnly(true);
        label_2 = new QLabel(MotionUi);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 200, 46, 13));
        ...
        label_4->setGeometry(QRect(10, 170, 46, 20));
        ...
        chkCorrectErrors->setGeometry(QRect(70, 170, 211, 21));
        chkCorrectErrors->setChecked(true);
        sbCorrection = new QSpinBox(MotionUi);
        sbCorrection->setObjectName(QStringLiteral("sbCorrection"));
        sbCorrection->setGeometry(QRect(290, 170, 71, 22));
        sbCorrection->setMaximum(1000);
        sbCorrection->setValue(900);
        chkAdaptive = new QCheckBox(MotionUi);
        chkAdaptive->setObjectName(QStringLiteral("chkAdaptive"));
        chkAdaptive->setGeometry(QRect(70, 120, 161, 20));
    ...
    void retranslateUi(QDialog *MotionUi)
    {
        ...
        chkAdaptive->setText(QApplication::translate("MotionUi", "Use adaptive clustering", 0));
    } // retranslateUi
