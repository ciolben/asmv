...
void Decode_Picture (int bitstream_framenum, 
  int sequence_framenum, int skip=0);
void Output_Last_Frame_of_Sequence (int framenum);



/*getpicConvert.c */
void Convert_Frame  ( unsigned char *src[],int frame,unsigned char *result);
void Decode_Picture_toImages(int bitstream_framenum,
			     int sequence_framenum,
			     unsigned char* result
			     );
void Output_Last_Frame_of_Sequence_toImages(int Framenum, unsigned char *result );
